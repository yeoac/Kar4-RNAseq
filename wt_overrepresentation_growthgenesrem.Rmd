---
title: "Overrepresentation Analysis - wt with growth genes removed"
...
```{r}
wt_up <- read.table(file = "wt_DEUP_growthgenesremov.txt", header = TRUE, row.names = 1, sep = "\t")
wt_down <- read.table(file = "wt_DEDown_growthgenesremov.txt", header = TRUE, row.names = 1, sep = "\t")

wt_rownames_up <- rownames(wt_up)
wt_rownames_down <- rownames(wt_down)
```
...
write.table(x = go.annot.df, 
          file = paste0("./GO_annotation/wt_up_growthgenesrem.txt"),
          sep = "\t", 
          col.names = NA)
...
write.table(x = go_overrep.up.df, 
          file = paste0("./GO_overrepresentation/GO_overrep_wt_up_growthgenesrem.txt"),
          sep = "\t", 
          col.names = NA)
```
...
write.table(x = go.annot.down.df, 
          file = paste0("./GO_annotation/GO_annot_wt_down_growthgenesrem.txt"),
          sep = "\t", 
          col.names = NA)
...
write.table(x = go_overrep.down.df, 
          file = paste0("./GO_overrepresentation/GO_overrep_wt_dowgrowthgenesrem.txt"),
          sep = "\t", 
          col.names = NA)
```
...
p1 <- draw_enrichment_barplot(my_enricher_obj = go_overrep.up, my_pathway_counts = 300, file_name_prefix = "./GO_overrepresentation/wt_up_growthgenesrem", my_width = 10, my_height = 10, padj_cutoff = 0.05)

p2 <- draw_enrichment_barplot(my_enricher_obj = go_overrep.down, my_pathway_counts = 300, file_name_prefix = "./GO_overrepresentation/wt_down_growthgenesrem", my_width = 10, my_height = 10, padj_cutoff = 0.05)
```